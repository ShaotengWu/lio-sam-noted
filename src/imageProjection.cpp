...
public:
    ...
    void cloudHandler(const sensor_msgs::PointCloud2ConstPtr &laserCloudMsg)
    {
        ...
        //    点云变换到起始点坐标系下 并且将range存在rangeMat中
        projectPointCloud();

        // 筛选可以用的点 并且存相关信息 每一根线可以用来计算曲率的点的起止index
        cloudExtraction();
